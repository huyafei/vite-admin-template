...
[github address](https://github.com/jzfai/vite-admin-template.git)

[Access address](http://8.135.1.141/vite-admin-template)

国内体验地址：http://8.135.1.141/vite-admin-template

github 地址：  https://github.com/jzfai/vite-admin-template.git
...
- js version for plus：[vite-admin-template](https://github.com/jzfai/vite-admin-template.git)
...
[Comparison of packaging speed between vite2 and webpack](https://github.com/jzfai/vite-admin-template/issues/2)

## Build Setup

```bash
# clone the project
git clone https://github.com/jzfai/vite-admin-template.git
...
[MIT](https://github.com/jzfai/vite-admin-template/blob/master/LICENSE) license.
